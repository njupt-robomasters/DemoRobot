...
String XboxControllerNotificationParser::toString() {
  ...
  String str = String("") +
    ...
    " LS:" + String(btnLS) +
    " RS:" + String(btnRS) +
    " DirUp:" + String(btnDirUp) +
    " DirRight:" + String(btnDirRight) +
    " DirDown:" + String(btnDirDown) +
    " DirLeft:" + String(btnDirLeft) +
    " LHori:" + String(joyLHori) +
    " LVert:" + String(joyLVert) +
    " RHori:" + String(joyRHori) +
    " RVert:" + String(joyRVert) +
